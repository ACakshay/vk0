...
if(isset($_GET['rs']))
{
	...
	$showResultId = $_GET['rs'];
	$showResultId = explode(",",$showResultId); 
	...
	{	
		...
		$sqldate1= $sqldate1." a.TransactionMode='".$tMode."' and a.isClosed=0 and a.isDelete=0 and a.isExtended=0 ";
	...
	if(count($trnsExtendedIdArr))
	{
		...
		$sqlExt=$sqlExt." in(".implode(',', $trnsExtendedIdArr).") and b.TransactionMode = '".$tMode."' ";

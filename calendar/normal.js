...
var gWeekDay=["<img src='sun027.gif' hight=20 width=20>","Mo","Tu","We","Th","Fr","Sa"];	// weekday caption from Sunday to Saturday

var gBegin=[2010,1,1];	// static calendar range begin from [Year,Month,Date]
var gEnd=[2119,12,31];	// static calendar range end at [Year,Month,Date]

...
//fAddEvent(2007,10,17,"Hello World!","fHoliday('17','10','2007');","skyblue","dodgerblue");
//fAddEvent(2007,10,17,"Hello World!","fHoliday(17,10,2007);","skyblue","dodgerblue");
...
////////////////////////////////////////////////////////////////////
function fHoliday(d,m,y) {
	var r=fGetEvent(d,m,y); // get agenda event.
	...
	if (m==1&&d==1)
	{
		r=[" Jan 1, "+y+" \n Happy New Year! ","dfsdfsdf","skyblue","red"];
		//alert(r);
	}
	else if (m==12&&d==25)
		{r=[" Dec 25, "+y+" \n Merry X'mas! ","dfsdf","skyblue","red"];	// show a line-through effect
		//alert(r);
		}
	else if (m==10&&d==17)
		{r=[" Oct 17, "+y+" \n My Day! ","dsfsdf","skyblue","red"];	// show a line-through effect
		alert(r);
		}
	else if (m==5&&d>20) {
...
function getDateByDOW(m,q,y,n) { // return the actual date of the q-th n-day in the specific month (y,m), you may delete it if no need.
